...
export function GlobalReachSection() {
  return (
    <section id="global-reach" className="relative py-24 lg:py-32 overflow-hidden bg-white">
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-10 p-6 rounded-2xl bg-secondary/50 border border-border text-center max-w-6xl mx-auto"
        >
