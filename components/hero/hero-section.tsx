      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 pt-24">
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-16 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            >
              We combine deep expertise in lightweight game design with
              cutting-edge AI technology to create engaging, culturally-adapted
              gaming experiences for emerging markets. From card strategy to
              casual puzzles, every interaction is enhanced by intelligent
              systems that understand player behavior and deliver personalized
            ...
            >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-2 border-primary/20 text-foreground hover:bg-primary/5 hover:border-primary/60 hover:text-foreground transition-all duration-300 hover:scale-105 text-base px-8 h-12 rounded-xl shadow-soft"
              >
              ...
              {[
                {
                  ...
                  sublabel: "Across all titles",
                },
                {
                  value: "12",
                  label: "Countries",
                  sublabel: "Asia & Middle East",
                },
                {
                  value: "14.9B",
                  label: "Tokens/Day",
