...
import { MapPin, Mail, Building2, Send, Sparkles, Globe, Users, Clock, Handshake, MessageSquare, HelpCircle, ArrowRight } from "lucide-react"

const offices = [
  { city: "Shenzhen", role: "R&D Headquarters", detail: "Core AI & game development team, 150+ engineers" },
  { city: "Singapore", role: "Southeast Asia Operations", detail: "Regional publishing, partnerships & business development" },
  { city: "Bangalore", role: "India Engineering Center", detail: "India market operations, localization & QA" },
]
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10 pt-24">
          ...
          >
            ...
            >
              ...
              <span className="font-semibold text-primary">technology partner</span>, or{" "}
              <span className="font-semibold text-primary">investor</span> — we'd love to explore how we can create value together.
            </motion.p>
            ...
            >
              With offices across Asia and a team of 200+ professionals,
              we're always looking for partners who share our vision of AI-native gaming
            ...
            >
              {[
                { value: "12", label: "Countries", sublabel: "Active operations" },
                { value: "50+", label: "Partners", sublabel: "Across the ecosystem" },
                { value: "3", label: "Offices", sublabel: "SZ · SG · BLR" },
                { value: "<48h", label: "Response Time", sublabel: "For all inquiries" },
              ].map((stat, index) => (
                <motion.div
                  key={stat.label}
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Fill out the form below or reach us directly at any of our offices. We respond to all inquiries within 2 business days.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-5 gap-12 max-w-6xl mx-auto">
            ...
            >
              <div>
                <h3 className="text-xl font-bold text-foreground mb-2">Starflare Technology Company Limited</h3>
                <p className="text-muted-foreground text-sm leading-relaxed">
                  AI-native lightweight gaming company serving 20M+ players across 12 countries in Southeast Asia & Middle East.
                </p>
              </div>
                ...
                <div className="space-y-3">
                  {offices.map((office, index) => (
                    ...
                    >
                      ...
                      <div className="text-sm text-primary font-medium ml-5">{office.role}</div>
                      <div className="text-xs text-muted-foreground ml-5 mt-1">{office.detail}</div>
                    </motion.div>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="p-4 rounded-xl bg-card border border-border">
                    ...
                    <div className="text-sm text-primary mt-1">contact@starflare.tech</div>
                  </div>
                  <div className="p-4 rounded-xl bg-card border border-border">
                    <div className="text-sm font-medium text-foreground">Business Development</div>
                    <div className="text-sm text-primary mt-1">partnerships@starflare.tech</div>
                  </div>
                  <div className="p-4 rounded-xl bg-card border border-border">
                    <div className="text-sm font-medium text-foreground">Press & Media</div>
                    <div className="text-sm text-primary mt-1">press@starflare.tech</div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-5 rounded-xl bg-gradient-to-br from-primary/5 to-accent/5 border border-primary/10">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="font-semibold text-foreground">Business Scope</span>
                </div>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Operating across India, Thailand, Indonesia, Vietnam, Saudi Arabia, UAE, Egypt, Pakistan, Bangladesh, Philippines, Malaysia, and Myanmar.
                </p>
              </div>
            </motion.div>
            ...
            >
              {submitted ? (
                <div className="bg-card border border-border rounded-2xl p-12 text-center shadow-soft">
                  ...
                  <p className="text-muted-foreground mb-6">Thank you for reaching out. We'll get back to you within 2 business days.</p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="bg-card border border-border rounded-2xl p-8 lg:p-10 shadow-soft">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <input
                        ...
                        required
                        value={formData.name}
                        onChange={(e) => { setFormData({ ...formData, name: e.target.value }); e.target.setCustomValidity("") }}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onInvalid={(e) => {
                          ...
                          if (input.validity.valueMissing) input.setCustomValidity("Please fill in this field.")
                          else if (input.validity.typeMismatch) input.setCustomValidity("Please enter a valid email address.")
                        }}
                        className="w-full px-4 py-3 rounded-xl bg-secondary border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all"
                  ...
                  <div className="grid sm:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                      <label htmlFor="interest" className="block text-sm font-medium text-foreground mb-2">Business Interest *</label>
                      <select
                        id="interest"
                        required
                        value={formData.interest}
                        onChange={(e) => { setFormData({ ...formData, interest: e.target.value }); e.target.setCustomValidity("") }}
                        onInvalid={(e) => (e.target as HTMLSelectElement).setCustomValidity("Please select an option.")}
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      onChange={(e) => { setFormData({ ...formData, message: e.target.value }); e.target.setCustomValidity("") }}
                  ...
                  <Button type="submit" className="w-full bg-gradient-to-r from-primary to-accent text-white hover:shadow-hover hover:scale-[1.02] transition-all duration-300 h-12 text-base rounded-xl">
                    <Send className="w-4 h-4 mr-2" />
                    Send Message
                  </Button>

                  <p className="text-xs text-muted-foreground text-center mt-4">
                    We typically respond within 2 business days. Your information is kept confidential.
                  </p>
                </form>
              )}
            </motion.div>
      ...
      <section className="py-24 border-t border-border relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We work with partners across the gaming ecosystem — from publishers to technology providers to investors.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Partner with us to publish your games in Southeast Asia and Middle East markets. We handle localization, user acquisition, and live ops.",
              },
              {
                icon: MessageSquare,
                title: "AI Technology Licensing",
                description: "License our AI platform for your own game operations — from intelligent NPCs to dynamic difficulty and anti-cheat systems.",
              },
              {
                icon: Globe,
                title: "Market Expansion",
                description: "Leverage our local presence and cultural expertise to expand your games into new emerging markets with confidence.",
              },
              {
                icon: Users,
                title: "Investor Relations",
                description: "We're backed by leading gaming and AI investors. Interested in our growth story? Let's connect.",
              },
              {
                icon: Building2,
                title: "Strategic Alliance",
                description: "Explore deeper integration opportunities — co-development, shared technology, or joint ventures in new markets.",
              },
              {
                icon: Mail,
                title: "Media & Press",
                description: "Journalists, analysts, and content creators — reach out for press kits, interviews, or industry commentary.",
              },
            ].map((item, index) => (
              <motion.div
                key={item.title}
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-10">
              Scroll back up to send us a message, or reach out directly at any of our email addresses. We look forward to hearing from you.
            </p>
